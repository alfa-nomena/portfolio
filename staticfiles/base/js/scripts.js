...
const skills__level = document.querySelectorAll('.skills__number')
skills__level.forEach(level =>{
...
modalProjectBtns.forEach((modalProjectBtn) => {
    console.log(modalProjectBtn)
})
